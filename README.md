...
* Adding more advanced functionality to owt such as NTP amplification attacks to screw with NTP servers for dosing websites. Adding AP tracking functionality and ability to save lists of common saved networks that devices have in the area. I.E if there is a starbucks near by you can track if starbucks is a common AP that peoples phones in the area have as a saved network. This is useful for knowing which APs to spoof. Adding a method of saving text files of device names and mac-addresses on a newtwork. 
